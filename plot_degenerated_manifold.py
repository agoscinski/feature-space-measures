...
soap_bs_gto_features = representation.transform(
    frames).get_features_by_species(representation)[(1, 1, 1)][::5]
...
truncated_soap_bs_gto_features = extract_principal_compononents(
    soap_bs_gto_features)
print('Finished eigendecomposition of power spectrum features')
print('Starting eigendecomposition of bispectrum features...')
truncated_soap_ps_gto_features = extract_principal_compononents(
    soap_ps_gto_features)
print('Finished eigendecomposition of bispectrum features')
plot_first_3_features(truncated_soap_ps_gto_features,
                      'Power spectrum first 3 principal components')
plot_first_3_features(truncated_soap_bs_gto_features,
                      'Bispectrum first 3 principal components')
