...
def plot_feature_space_measure_matrix(measure_matrix):
    ...
    plt.yticks(np.arange(4),[r'$\textrm{RS}_{\textrm{DVR}}$',r'$\textrm{RS}_{\textrm{GTO}}$',r'$\textrm{PS}_{\textrm{DVR}}$',r'$\textrm{PS}_{\textrm{GTO}}$'],fontsize=19)
    plt.xticks(np.arange(4),[r'$\textrm{RS}_{\textrm{DVR}}$',r'$\textrm{RS}_{\textrm{GTO}}$',r'$\textrm{PS}_{\textrm{DVR}}$',r'$\textrm{PS}_{\textrm{GTO}}$'],fontsize=19)
    plt.ylim(-0.5,3.5)
